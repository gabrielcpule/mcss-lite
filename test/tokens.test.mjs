...
const PAIRS = [
  ...
  ['color.text.on-action', 'color.action.primary.active', 4.5],
  ['color.action.primary.$root', 'color.background.default', 3],
  ['color.border.keyline', 'color.background.canvas', 3],
  ['color.border.keyline', 'color.background.raised', 3],
  ['color.border.error', 'color.background.interactive', 3],
  ['color.border.success', 'color.background.interactive', 3],
  ['color.border.warning', 'color.background.interactive', 3],
  ['color.border.info', 'color.background.interactive', 3],
  ['color.action.primary.$root', 'color.background.interactive', 3],
  ...
  ...['default', 'canvas', 'raised', 'subtle', 'muted', 'interactive', 'interactive-hover', 'callout', 'disabled']
    .map((bg) => ['color.focus-ring.$root', `color.background.${bg}`, 3]),
