...
export const RULES = [
  ...
  },
  {
    ...
    text: 'Use only the classes, modifiers, elements, data-state values and tokens listed in this file. If something is missing, write custom CSS with existing tokens instead of guessing a name such as c-button--danger.',
  },
  {
    id: 'states',
...
export function generate(root) {
  ...
  const files = new Map();
  files.set('src/tokens.css', buildCss(sets, byMode));
...
function buildCss(sets, byMode) {
  ...
  return [
    ...
    block('[data-theme="auto"]', themed('dark')).trimEnd().split('\n').map((l) => (l ? '  ' + l : l)).join('\n'),
    '}',
    '',
  ].join('\n');
}
